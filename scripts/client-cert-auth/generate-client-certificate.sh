...
echo "Signing the csr to a certificate, valid for 10 years."
echo extendedKeyUsage = clientAuth > extfile-client.cnf
openssl x509 -req -days 3650 -in $1.csr -CA ca.crt -CAkey ca.key -set_serial 01 -out $1.crt -extfile extfile.cnf
